...
export const ProductsContextProvider = (props) => {
  ...
  const [isViewingAudio1, setIsViewingAudio1] = useState(false);
  const [isViewingAudio2, setIsViewingAudio2] = useState(false);
  const [isViewingVideo1, setIsViewingVideo1] = useState(false);
  const [isViewingVideo2, setIsViewingVideo2] = useState(false);
  const [isViewingWarpstagram1, setIsViewingWarpstagram1] = useState(false);
  const [isViewingWarpstagram2, setIsViewingWarpstagram2] = useState(false);
  const [isViewingBundle, setIsViewingBundle] = useState(false);
