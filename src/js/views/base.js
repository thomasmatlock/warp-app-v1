export const elements = {
    ...
    test_add_item_0_arr: document.querySelectorAll('.test_add_item_0'),
    test_add_item_1_arr: document.querySelectorAll('.test_add_item_1'),
    test_add_item_2_arr: document.querySelectorAll('.test_add_item_2'),
    test_add_item_3_arr: document.querySelectorAll('.test_add_item_3'),
};
