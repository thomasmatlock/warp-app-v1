...
const toggleVisibility = (state, avType) => {
                                if (state.modals.preferences) {
                                                                if (avType === 'audio') elements.modalParentAudio.style.display = 'flex'; // de-activate modal background
                                                                elements.modalContainerAudio.style.display = 'flex';
                                                                if (avType === 'video') elements.modalParentVideo.style.display = 'flex';
...
const showPanel = (modalType, avType) => {
                                // console.log('hello');
                                let modalPrefsPanel_audio = document.getElementById('modalPrefsPanel_audio');
                                let modalPrefsPanel_video = document.getElementById('modalPrefsPanel_video');
                                let modalPrefsPanel_warpstagram = document.getElementById(
                                                                'modalPrefsPanel_warpstagram'
                                );
                                let modalPrefsPanel_general = document.getElementById(
                                                                'modalPrefsPanel_general'
                                );
                                let modalPrefsPanel_license = document.getElementById(
                                                                'modalPrefsPanel_license'
                                );
                                let modalPrefsPanel_ALL = [
                                                                modalPrefsPanel_audio,
                                                                modalPrefsPanel_video,
                                                                modalPrefsPanel_warpstagram,
                                                                modalPrefsPanel_general,
                                                                modalPrefsPanel_license,
                                ];
                                if (avType === 'audio') {
                                                                toggleAllPrefsPanels(modalPrefsPanel_ALL, modalPrefsPanel_audio);
                                }
                                if (avType === 'video') {
                                                                toggleAllPrefsPanels(modalPrefsPanel_ALL, modalPrefsPanel_video);
                                }
                                if (avType === 'warpstagram') {
                                                                toggleAllPrefsPanels(modalPrefsPanel_ALL, modalPrefsPanel_warpstagram);
                                }
                                if (avType === 'general') {
                                                                toggleAllPrefsPanels(modalPrefsPanel_ALL, modalPrefsPanel_general);
                                }
                                if (avType === 'license') {
                                                                toggleAllPrefsPanels(modalPrefsPanel_ALL, modalPrefsPanel_license);
                                }
...
const insertOutputFolderPaths = (storage) => {
                                ...
                                setTimeout(() => {
                                                                ...
                                                                document.getElementById('modalPrefsOutputFolder_video').placeholder =
                                                                                                outputPaths.video;
                                                                document.getElementById('modalPrefsOutputFolder_warpstagram').placeholder =
                                                                                                outputPaths.warpstagram;
                                }, 100);
};
...
const setDropdownsAll = (storage) => {
                                const dropdownsObj = {
                                                                ...
                                                                general_theme: document.getElementById('modalDropdown_general_theme'),
