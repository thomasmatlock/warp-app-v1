...
// import { PrismaClient } from 'C:\\Users\\Tommy\\Documents\\GitHub\\warp-app\\node_modules\\.prisma\\client\\'; // trying to use the prisma client here with new path
import { PrismaClient } from 'C:\\Program Files\\Warp\\resources\\node_modules\\@prisma\\client'; // trying to use the prisma client here with new path
